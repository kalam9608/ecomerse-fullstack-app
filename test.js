...
// const categoriesProduct=products.map(p=>p.category);
// const categoriesProduct=[products.map(p=>p.category)];

// const categoriesProduct=[...products.map(p=>p.category)];
// const categoriesProduct=new Set([...products.map(p=>p.category)]);
const categoriesProduct=[...new Set([...products.map(p=>p.category)])];



const categories=categoriesProduct.map(c=>({value:c,label:c.split('-').join(' '),checked:false}))
