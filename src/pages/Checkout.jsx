...
import {
  deleteCartItemsAsyncById,
  selectedItems,
  updateCartItemsAsyncById,
} from "../components/features/cart/cartListSlice";
...
import { createOrderAsync } from "../components/features/order/orderSlice";
...
function Checkout() {
  ...
  const handleOrder = () => {
    const order = { items: items, user, paymentMethod, selectedAddress };
